        ...
        !empty($_POST["surname"]) && !empty($_POST["confirm_password"]) && !empty($_POST["allow"]))
    {
        ...
        if (count($error) == 0) {
            ...
            if (mysqli_query($conn, $query)) {
                $_SESSION["_gym_username"] = $_POST["username"];
                $_SESSION["_gym_user_id"] = mysqli_insert_id($conn);
                mysqli_close($conn);
                header("Location: index.php");
                exit;
            } else {
...
<html>
    ...
    <body>
        ...
        <section class="main_right">
            <h1>Iscriviti! <br> Gabriele o Graziano accetteranno la tua richiesta il prima possibile</h1>
